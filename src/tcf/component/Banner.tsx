...
class Banner extends Component<Props, State> {
	...
	public render(): React.ReactNode {
		...
		const { onOptionsClick, privacyPolicyUrl, cookiePolicyUrl } = this.props;

		return (
			<FontsContext.Consumer>
				{({ headlineSerif, bodySerif, bodySans }: FontsContextInterface) => (
					<div css={bannerStyles}>
						<div css={outerContainerStyles}>
							...
							<div css={contentContainerStyles(bodySerif)}>
								<div>
									<h1 css={headlineStyles(headlineSerif)}>Your privacy</h1>
								</div>
								<div css={mobileScrollable}>
									<p>
										...
										use your information – collected through cookies and similar
										technologies – to improve your experience on our site,
										analyse how you use it and show you personalised
										advertising.
									</p>
									<p>
										...
										, and manage your consent at any time by going to ‘Privacy
										settings’ at the bottom of any page.
									</p>
									<button
										css={collapsibleButtonStyles(showInfo, bodySerif)}
										onClick={() => {
											this.setState({
												showInfo: !showInfo,
											});
										...
										tabIndex={2}
									>
										<span css={visuallyHiddenStyles}>Show</span> Information
										that may be used
									</button>
									<ul
										id={INFO_LIST_ID}
										css={collapsibleListStyles(showInfo, bodySerif)}
									>
									...
									<button
										css={collapsibleButtonStyles(showPurposes, bodySerif)}
										onClick={() => {
											this.setState({
										...
										tabIndex={3}
									>
										<span css={visuallyHiddenStyles}>Show</span> Purposes
									</button>
									<ul
										id={PURPOSE_LIST_ID}
										css={collapsibleListStyles(showPurposes, bodySerif)}
									>
								...
								<ThemeProvider theme={buttonBrand}>
									<div css={buttonContainerStyles}>
										<Button
											...
											onClick={() => {
												const { onEnableAllAndCloseClick } = this.props;
