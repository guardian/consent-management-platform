					...
					<>
						...
						<form css={modalStyles}>
							...
							<div css={scrollableContainerStyles}>
								...
								>
									...
									<IabPurposes
										...
										iabState={iabState}
										updateItem={(id: number, updatedValue: boolean) => {
											this.updateIabState(id, updatedValue);
										}}
										showError={(id: number) => iabNullResponses.includes(id)}
									/>
									<Features features={parsedVendorList.features} />
									<Vendors
							...
							<div css={buttonContainerStyles(bodySerif)}>
								...
								<p>
									You can change the above settings for this browser at any time
									by clicking the privacy settings link in the footer of the
									page.
								</p>
